...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="createevents();">
		...
		<div id="content" class="left-indent right-indent">
			...
			<p>Please, leave a small commentary for next visitors. It's not necessary to type your real name, nickname or e-mail, but it will be nice. I will delete any post-it consider offensive or inmoral; the maximum number of characters per post-it is 250. Of course the engine for data access behind this page is ObjectDB! For read user's post-it, follow <a href="userpostit.php">this</a> link.</p>
